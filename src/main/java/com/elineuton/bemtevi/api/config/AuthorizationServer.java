 ...
 * @Configuration
 * 
 * @EnableAuthorizationServer public class AuthorizationServer extends
 ...
 * throws Exception { clients.inMemory() .withClient("app-client")
 * .secret("app-secret") .scopes("resource-server-read",
