...
public class AlunoResource {
	...
	/*
	 * @PostMapping("/{id}/pessoalAutorizado") public ResponseEntity<Aluno>
	 * inserir(@Valid @RequestBody AlunoNewDTO alunoNewDTO) { Aluno aluno =
	 * service.fromDTO(alunoNewDTO); aluno = service.inserir(aluno); return
